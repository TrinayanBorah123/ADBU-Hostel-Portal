<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		$rs=mysqli_query($con,"insert into requisition value(default,'$details','$adate','$sid')");
  ...
  <nav class="navbar fixed-top navbar-expand-lg  navbar-light bg-light">
   ...
   <center>
	...
	<div style="margin-top:140px;">
	 <p style="text-align:center;font-size: 35px;font-family: Consolas;"><font style="margin-right:16px ">Requisition Submission</font><i class="fas fa-check"></i></p>
	<hr/>
	</div >
	<div>
	<?php 
	...
	<hr/>
  	...
  	<form style="word-spacing: 50px;margin-top: 20px" action="" method="POST">
		  ...
		  <textarea style="margin-left: 10px;margin-top: 20px; padding-left: 10px;width: 400px;height:80px; box-sizing: border-box;border: 2px solid #000; border-radius: 4px;"  name="details" placeholder="Requisition Details" required></textarea>
		<input  style="margin-left: 10px;margin-top:40px" type="submit" name="submit" value="SUBMIT">
    </form> 
