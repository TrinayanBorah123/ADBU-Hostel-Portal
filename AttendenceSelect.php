...
<body>
  ...
  <div style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 40%;height:490px;border-radius: 5px; ">
	<div style="margin-top:160px;">
	 <p style="font-size: 35px;font-family: Consolas;"><font style="margin-right:16px ">Check Availability</font><i class="fas fa-check"></i></p>
	<hr/>
	</div >
	
  	<form  style="margin-top:60px;" action="AttendenceUpload.php" method="POST">
