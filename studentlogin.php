...
<body >
  ...
  <div style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 40%;height:490px;border-radius: 5px; ">
	<div style="margin-top:160px;background-color:#6c757d;color:#ffffff">
	 <p style="text-align:center;font-size: 35px;font-family: Fabric;" id="head1">Student Login</p>
	<hr/>
	</div >
	<div>

  	<form style="word-spacing: 50px;margin-top: 80px" action="" method="POST">
		 <input  style="margin-left: 10px" type="text" name="stid" placeholder="Student ID" required></br>
	...
	<p style="margin-top:20px; "><a href="studentregister.php" style="text-decoration:none ">Do not have an account?<i class="fas fa-user-plus"></i></a></p>
   ...
   // session_start();
	...
	if(!$db_selected)
	{
     ...
     if(isset($_POST['stid'])){
      ...
      $sql = "SELECT sid FROM Student WHERE sid = '".$myuserid."' and Password = '".$mypassword."'";
