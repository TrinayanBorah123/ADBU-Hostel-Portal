...
<body>
  <nav class="navbar fixed-top navbar-expand-lg  navbar-light bg-light">
	...
	<div style="margin-top:180px;">
	 ...
	 <div class="row">
  		<input  style="margin-left: 30px;width:360px" type="text" name="sid"  id="sid" placeholder="Student ID" required class="form-control">
    ...
    <thead class="thead-dark">
      ...
      echo '<tr >';
        echo '<th scope="row">'.$Cust['sid'].'</td>';
        echo '<td>'.$Cust['sname'].'</td>';
		echo '<td>'.$Cust['branch'].'</td>';
		echo '<td>'.$Cust['sem'].'</td>';
		echo '<td>'.$Cust['contact'].'</td>';
		
		/*echo "<td><a  style=\"cursor:pointer;text-decoration:none;\"  href=\"Parentcontact.php?id={$Cust['sid']}\">Click Here</a></button></td>"; */
		
		?>
		 <td><input type="button" name="view" value="Click here" id="<?php echo $Cust["sid"]; ?>" class="btn btn-info btn-xs view_data" data-toggle="modal" data-target="#dataModal" /></td>
        <?php
	   echo '</tr>';
      }
    ?>   
