...
<body>
  <nav class="navbar fixed-top navbar-expand-lg  navbar-light bg-light">
	...
	<div style="margin-top:280px;">
	 <p style="text-align:center;font-size: 35px;font-family: Consolas;"><font style="margin-right:16px ">Room Change Request Sent Successfully</font><i class="fas fa-check"></i></p>
