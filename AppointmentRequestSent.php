...
<body>
  <nav class="navbar fixed-top navbar-expand-lg  navbar-light bg-light">
	...
	<div style="margin-top:280px;">
	 <p style="text-align:center;font-size: 35px;font-family: Consolas;"><font style="margin-right:16px ">Appointment Request Sent Successfully</font><i class="fas fa-check"></i></p>
	
	</div >
	<div>
	<center>
  	<button class="btn btn-secondary" ><a style="color:white ;text-decoration:none" href="studentDash.php">HOME</a></button>
	</center>
